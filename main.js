...
const bmiDescriptions = {
    underweight:
        "Being underweight can lead to nutritional deficiencies, a weakened immune system, and potential health issues such as osteoporosis, anemia, and fertility problems. It is recommended to consult a healthcare professional for guidance on achieving a healthy weight.",
    ...
    overweight:
        "Being overweight increases the risk of developing chronic conditions like high blood pressure, heart disease, stroke, and type 2 diabetes. It is recommended to adopt a healthier lifestyle by incorporating a balanced diet and regular exercise to achieve a healthy weight.",
    moderateObesity:
        "Moderate obesity can significantly increase the risk of developing serious health problems, including cardiovascular diseases, type 2 diabetes, sleep apnea, and certain types of cancer. It is advisable to seek professional guidance from a healthcare provider to develop a comprehensive plan for weight management.",
    severeObesity:
        "Severe obesity poses a considerable threat to overall health and well-being. It significantly increases the risk of developing life-threatening conditions such as heart disease, stroke, type 2 diabetes, and certain types of cancer. Seeking professional medical guidance and support is highly recommended for effective weight management and improving overall health.",
    morbidObesity:
...
document.querySelectorAll(".content-btn > button").forEach((el, index) => {
    el.addEventListener("click", (e) => {
        ...
        if (e.target.dataset.btn === "next") {
            currentContentIndex =
                currentContentIndex < maxContent - 1
